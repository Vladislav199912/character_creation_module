...
def attack(char_name: str, char_class: str) -> str:
    """В зависимости от класса выбираем урон, который он наносит."""
...
def defence(char_name: str, char_class: str) -> str:
    """В зависимости от класса выбираем количество блокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """В зависимости от класса выбираем количество очков умений."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор класса и описание класса."""
    approve_choice: str = ''
    char_class: str = ''
    while approve_choice != 'y':
        ...
        if char_class == 'mage':
            print('Маг — находчивый воин дальнего боя.'
                  'Обладает высоким ВЛАД интеллектом.')
        if char_class == 'healer':
...
print(cleandoc(attack.__doc__))
print(cleandoc(defence.__doc__))
